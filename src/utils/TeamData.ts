  ...
  export const teamMembers: TeamMember[] = [
    {
      ...
      joinedYear: "2019",
      featured: "Fundador",
      bio: "Desarrollador de automatizaciónes de procesos para la eficacia y recorte de tiempo en los proyectos.",
      bioExtended: "Sergio lidera nuestro equipo técnico y define la arquitectura de nuestros proyectos. Con experiencia en startups y grandes empresas, aporta una visión estratégica y técnica a cada desarrollo. Su experiencia se centra en arquitecturas escalables y seguras, implementando las mejores prácticas de la industria.",
      ...
      education: "Tecnologó en Análisis y desarrollo de software",
      experience: 10,
      languages: [
    ...
    },
    {
      ...
      location: "Medellín, Colombia",
      joinedYear: "2020",
      bio: "Creador del funcionamiento de la diferentes aplicaciones y del servidor para el contacto con nuestro frontend",
    ...
    },
    {
      ...
      skills: ["RoR", "Spring Boot", "Net.", "Database", "Linux Ubuntu", "Bitbucket", "Git"],
      education: "Analisis y Desarrollo de Software",
      experience: 7,
      languages: [
        { name: "Español", level: "Nativo", percentage: 100 },
